...
class ETRI_STT_API():
    ...
    def get_filepath(self):
        return os.path.join(os.path.dirname(__file__), self.folderpath, self.filename + ".wav")

    def get_origin_script(self):
        filepath = os.path.join(os.path.dirname(__file__), self.folderpath, self.filename + ".txt")
...
class SplitWavAudioMubin():
    def __init__(self, folder, filename):
        self.folder = folder
        self.filename = filename
        self.filepath = os.path.join(os.path.dirname(__file__), folder, filename + ".wav")
    ...
    def single_split(self, from_min, to_min, split_filename):
        ...
        split_audio_export_path = os.path.join(os.path.dirname(__file__), self.folder, split_filename)
    ...
    def remove_splited_files(self):
        ...
        for i in range(0, len(filelist)):
            remove_path = os.path.join(os.path.dirname(__file__), self.folder, filelist[i] + ".wav")
...
if __name__ == '__main__':
    ...
    failed_list = []
    count = 0
    folderpath = 'aihub_data\\hobby_01\\001'
    filename = "hobby_0000"
    start_num = 205
    end_num = 205
